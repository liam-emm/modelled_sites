# -*- coding: utf-8 -*-
"""
Created on Mon Jul 24 16:54:14 2023
...
sag1 = xr.open_dataset('sagnew1.grib', engine = 'cfgrib', chunks = 1000)
sag2 = xr.open_dataset('sagnew2.grib', engine = 'cfgrib', chunks = 1000)
sag3 = xr.open_dataset('sagnew3.grib', engine = 'cfgrib', chunks = 1000)

ag1 = xr.open_dataset('agnew1.grib', engine = 'cfgrib', chunks = 1000)
ag2 = xr.open_dataset('agnew2.grib', engine = 'cfgrib', chunks = 1000)
ag3 = xr.open_dataset('agnew3.grib', engine = 'cfgrib', chunks = 1000)
ag4 = xr.open_dataset('agnew4.grib', engine = 'cfgrib', chunks = 1000)
ag5 = xr.open_dataset('agnew5.grib', engine = 'cfgrib', chunks = 1000)
ag6 = xr.open_dataset('agnew6.grib', engine = 'cfgrib', chunks = 1000)
ag7 = xr.open_dataset('agnew7.grib', engine = 'cfgrib', chunks = 1000)
ag8 = xr.open_dataset('agnew8.grib', engine = 'cfgrib', chunks = 1000)
ag9 = xr.open_dataset('agnew9.grib', engine = 'cfgrib', chunks = 1000)

#%% Creating numpy arrays of relevent parameters
ag_u1 = ag1.u10.values[:,0,0]
ag_u2 = ag2.u10.values[:,0,0]
ag_u3 = ag3.u10.values[:,0,0]
ag_u4 = ag4.u10.values[:,0,0]
ag_u5 = ag5.u10.values[:,0,0]
ag_u6 = ag6.u10.values[:,0,0]
ag_u7 = ag7.u10.values[:,0,0]
ag_u8 = ag8.u10.values[:,0,0]
ag_u9 = ag9.u10.values[:,0,0]

ag_v1 = ag1.v10.values[:,0,0]
ag_v2 = ag2.v10.values[:,0,0]
ag_v3 = ag3.v10.values[:,0,0]
ag_v4 = ag4.v10.values[:,0,0]
ag_v5 = ag5.v10.values[:,0,0]
ag_v6 = ag6.v10.values[:,0,0]
ag_v7 = ag7.v10.values[:,0,0]
ag_v8 = ag8.v10.values[:,0,0]
ag_v9 = ag9.v10.values[:,0,0]

ag_t1 = ag1.t2m.values[:,0,0]
ag_t2 = ag2.t2m.values[:,0,0]
ag_t3 = ag3.t2m.values[:,0,0]
ag_t4 = ag4.t2m.values[:,0,0]
ag_t5 = ag5.t2m.values[:,0,0]
ag_t6 = ag6.t2m.values[:,0,0]
ag_t7 = ag7.t2m.values[:,0,0]
ag_t8 = ag8.t2m.values[:,0,0]
ag_t9 = ag9.t2m.values[:,0,0]

nans_ag_s1 = sag1.ssr.values
nans_ag_s2 = sag2.ssr.values
nans_ag_s3 = sag3.ssr.values

ag_s1 = nans_ag_s1[~np.isnan(nans_ag_s1)]
ag_s2 = nans_ag_s2[~np.isnan(nans_ag_s2)]
ag_s3 = nans_ag_s3[~np.isnan(nans_ag_s3)]

u = np.concatenate([ag_u1, ag_u2, ag_u3, ag_u4, ag_u5, ag_u6, ag_u7,
                    ag_u8, ag_u9])

v = np.concatenate([ag_v1, ag_v2, ag_v3, ag_v4, ag_v5, ag_v6, ag_v7,
                    ag_v8, ag_v9])

t = np.concatenate([ag_t1, ag_t2, ag_t3, ag_t4, ag_t5, ag_t6, ag_t7,
                    ag_t8, ag_t9]) - 273.15

s = np.concatenate([ag_s1, ag_s2, ag_s3]) / 3600
...
location = Location(latitude = latitude, longitude = longitude, tz = Australian,
                    altitude = 400, name = 'Agnew Gold Mine Solar Farm')
...
ax.set_title('Modelled Power Curve for Goldwind GW140 3.6 MW')
ax.legend()
...
weather_data.to_csv('pvlib_ag.csv')
...
plt.title('Average Monthly Solar Generation at Agnew Gold Mine for varying La Nina Conditions')

plt.xticks(index + bar_width/2, month_names, rotation=45)
plt.legend(loc='lower right')
plt.tight_layout()
plt.savefig('Monthly Average Solar Generation (Agnew)', dpi=600)
plt.show()
...
plt.title('Average Monthly Wind Generation at Agnew Gold Mine for varying La Nina Conditions')

plt.xticks(index + bar_width/2, month_names, rotation=45)
plt.legend(loc='lower right')
plt.tight_layout()
plt.savefig('Monthly Average Wind Generation (Agnew).png', dpi=600)
plt.show()
