# -*- coding: utf-8 -*-
"""
Created on Mon Jul 31 09:58:41 2023
...
sgr1 = xr.open_dataset('sgullen1.grib', engine = 'cfgrib', chunks = 1000)
sgr2 = xr.open_dataset('sgullen2.grib', engine = 'cfgrib', chunks = 1000)
sgr3 = xr.open_dataset('sgullen3.grib', engine = 'cfgrib', chunks = 1000)

gr1 = xr.open_dataset('gullen1.grib', engine = 'cfgrib', chunks = 1000)
gr2 = xr.open_dataset('gullen2.grib', engine = 'cfgrib', chunks = 1000)
gr3 = xr.open_dataset('gullen3.grib', engine = 'cfgrib', chunks = 1000)
gr4 = xr.open_dataset('gullen4.grib', engine = 'cfgrib', chunks = 1000)
gr5 = xr.open_dataset('gullen5.grib', engine = 'cfgrib', chunks = 1000)
gr6 = xr.open_dataset('gullen6.grib', engine = 'cfgrib', chunks = 1000)
gr7 = xr.open_dataset('gullen7.grib', engine = 'cfgrib', chunks = 1000)
gr8 = xr.open_dataset('gullen8.grib', engine = 'cfgrib', chunks = 1000)
gr9 = xr.open_dataset('gullen9.grib', engine = 'cfgrib', chunks = 1000)

#%% Creating numpy arrays of relevent parameters
gr_u1 = gr1.u10.values[:,0,0]
gr_u2 = gr2.u10.values[:,0,0]
gr_u3 = gr3.u10.values[:,0,0]
gr_u4 = gr4.u10.values[:,0,0]
gr_u5 = gr5.u10.values[:,0,0]
gr_u6 = gr6.u10.values[:,0,0]
gr_u7 = gr7.u10.values[:,0,0]
gr_u8 = gr8.u10.values[:,0,0]
gr_u9 = gr9.u10.values[:,0,0]

gr_v1 = gr1.v10.values[:,0,0]
gr_v2 = gr2.v10.values[:,0,0]
gr_v3 = gr3.v10.values[:,0,0]
gr_v4 = gr4.v10.values[:,0,0]
gr_v5 = gr5.v10.values[:,0,0]
gr_v6 = gr6.v10.values[:,0,0]
gr_v7 = gr7.v10.values[:,0,0]
gr_v8 = gr8.v10.values[:,0,0]
gr_v9 = gr9.v10.values[:,0,0]

gr_t1 = gr1.t2m.values[:,0,0]
gr_t2 = gr2.t2m.values[:,0,0]
gr_t3 = gr3.t2m.values[:,0,0]
gr_t4 = gr4.t2m.values[:,0,0]
gr_t5 = gr5.t2m.values[:,0,0]
gr_t6 = gr6.t2m.values[:,0,0]
gr_t7 = gr7.t2m.values[:,0,0]
gr_t8 = gr8.t2m.values[:,0,0]
gr_t9 = gr9.t2m.values[:,0,0]

nans_gr_s1 = sgr1.ssr.values
nans_gr_s2 = sgr2.ssr.values
nans_gr_s3 = sgr3.ssr.values

gr_s1 = nans_gr_s1[~np.isnan(nans_gr_s1)]
gr_s2 = nans_gr_s2[~np.isnan(nans_gr_s2)]
gr_s3 = nans_gr_s3[~np.isnan(nans_gr_s3)]

u = np.concatenate([gr_u1, gr_u2, gr_u3, gr_u4, gr_u5, gr_u6, gr_u7,
                    gr_u8, gr_u9])


v = np.concatenate([gr_v1, gr_v2, gr_v3, gr_v4, gr_v5, gr_v6, gr_v7,
                    gr_v8, gr_v9])

t = np.concatenate([gr_t1, gr_t2, gr_t3, gr_t4, gr_t5, gr_t6, gr_t7,
                    gr_t8, gr_t9]) - 273.15

s = np.concatenate([gr_s1, gr_s2, gr_s3]) / 3600
...
# Wind
# (GW100 2.5 MW)
wind_capacity_GW100 = 140      # MW
hub_height_GW100 = 80          # m
P_rated_wind_GW100 = 2.5       # MW
v_rated_GW100 = 11.1           # m/s
v_cut_in_GW100 = 3.0           # m/s
v_cut_out_GW100 = 25           # m/s
# (GW82 1.5 MW)
wind_capacity_GW82 = 25.5      # MW
hub_height_GW82 = 82           # m
P_rated_wind_GW82 = 1.5        # MW
v_rated_GW82 = 10.3            # m/s
v_cut_in_GW82 = 3.0            # m/s
v_cut_out_GW82 = 22            # m/s
...
location = Location(latitude = latitude, longitude = longitude, tz = Australian,
                    altitude = 400, name = 'Gullen Range Solar Farm')
...
#%% Wind Generation
number_of_turbines_GW100 = wind_capacity_GW100 // P_rated_wind_GW100
number_of_turbines_GW82 = wind_capacity_GW82 // P_rated_wind_GW82


# Wind Profile Calculation This only for region betwix cut in and rated wind speeds
# GW100
h1 = 10
h2_GW100 = hub_height_GW100
z0 = 0.05
v1 = np.sqrt(u**2 + v**2)
v2_GW100 = v1 * (math.log((h2_GW100)/(z0)))/(math.log((h1)/(z0)))

a_GW100 = P_rated_wind_GW100 * 1000000 / (v_rated_GW100**3 - v_cut_in_GW100**3)
b_GW100 = (v_rated_GW100**3) / (v_rated_GW100**3 - v_cut_in_GW100**3)

E_wind_GW100 = np.copy(v2_GW100)
E_wind_GW100[E_wind_GW100 < v_cut_in_GW100] = 0
E_wind_GW100[(E_wind_GW100 > v_cut_in_GW100) & (E_wind_GW100 < v_rated_GW100)] = (a_GW100 * E_wind_GW100[(E_wind_GW100 > v_cut_in_GW100) & (E_wind_GW100 < v_rated_GW100)]**3 - b_GW100 * P_rated_wind_GW100)/1000000
E_wind_GW100[(E_wind_GW100 > v_rated_GW100) & (E_wind_GW100 < v_cut_out_GW100)] = P_rated_wind_GW100
E_wind_GW100[E_wind_GW100 > v_cut_out_GW100] = 0

E_wind_GW100 *= number_of_turbines_GW100

# GW82
h2_GW82 = hub_height_GW82
v2_GW82 = v1 * (math.log((h2_GW82)/(z0)))/(math.log((h1)/(z0)))

a_GW82 = P_rated_wind_GW82 * 1000000 / (v_rated_GW82**3 - v_cut_in_GW82**3)
b_GW82 = (v_rated_GW82**3) / (v_rated_GW82**3 - v_cut_in_GW82**3)

E_wind_GW82 = np.copy(v2_GW100)
E_wind_GW82[E_wind_GW82 < v_cut_in_GW82] = 0
E_wind_GW82[(E_wind_GW82 > v_cut_in_GW82) & (E_wind_GW82 < v_rated_GW82)] = (a_GW82 * E_wind_GW82[(E_wind_GW82 > v_cut_in_GW82) & (E_wind_GW82 < v_rated_GW82)]**3 - b_GW82 * P_rated_wind_GW82)/1000000
E_wind_GW82[(E_wind_GW82 > v_rated_GW82) & (E_wind_GW82 < v_cut_out_GW82)] = P_rated_wind_GW82
E_wind_GW82[E_wind_GW82 > v_cut_out_GW82] = 0

E_wind_GW82 *= number_of_turbines_GW82
E_wind = E_wind_GW100 + E_wind_GW82
...
# GW100
step = 0.5
cut_in_wind_speed_GW100 = np.arange(0, v_cut_in_GW100, step)
cubic_wind_speed_GW100 = np.arange(v_cut_in_GW100, v_rated_GW100, step)
rated_wind_speed_GW100 = np.arange(v_rated_GW100, v_cut_out_GW100, step)
cut_out_wind_speed_GW100 = np.arange(v_cut_out_GW100, v_cut_out_GW100 + 5*step, step)

cubic_pc_GW100 = (a_GW100 * cubic_wind_speed_GW100**3 - b_GW100 * P_rated_wind_GW100)/1000000
cut_in_pc_GW100 = np.zeros_like(cut_in_wind_speed_GW100)
rated_pc_GW100 = np.zeros_like(rated_wind_speed_GW100) + P_rated_wind_GW100
cut_out_pc_GW100 = np.zeros_like(cut_out_wind_speed_GW100)

fig, ax = plt.subplots(figsize=(9,6))
ax.stem(cut_in_wind_speed_GW100, cut_in_pc_GW100, markerfmt = 'ro', linefmt = 'r', basefmt = 'none', label = 'Below Cut-In')
ax.stem(cubic_wind_speed_GW100, cubic_pc_GW100, markerfmt = 'bo', linefmt = 'b', basefmt = 'none', label = 'Cubic Model')
ax.stem(rated_wind_speed_GW100, rated_pc_GW100, markerfmt = 'go', linefmt = 'g', basefmt = 'none', label = 'Rated')
ax.stem(cut_out_wind_speed_GW100, cut_out_pc_GW100, markerfmt = 'ro', linefmt = 'r', basefmt = 'none', label = 'Above Cut-Out')
# ax.set_ylim(0,4)
ax.set_xlabel('Wind Speed (m/s)')
ax.set_ylabel('Turbine Output (MW)')
ax.set_title('Modelled Power Curve for Goldwind GW100 2.5 MW (Gullen Range)')
ax.legend()
# plt.savefig('Gullen Range Turbine Power Curve (2_5 MW)', dpi = 600)

# GW82
step = 0.5
cut_in_wind_speed_GW82 = np.arange(0, v_cut_in_GW82, step)
cubic_wind_speed_GW82 = np.arange(v_cut_in_GW82, v_rated_GW82, step)
rated_wind_speed_GW82 = np.arange(v_rated_GW82, v_cut_out_GW82, step)
cut_out_wind_speed_GW82 = np.arange(v_cut_out_GW82, v_cut_out_GW82 + 5*step, step)

cubic_pc_GW82 = (a_GW82 * cubic_wind_speed_GW82**3 - b_GW82 * P_rated_wind_GW82)/1000000
cut_in_pc_GW82 = np.zeros_like(cut_in_wind_speed_GW82)
rated_pc_GW82 = np.zeros_like(rated_wind_speed_GW82) + P_rated_wind_GW82
cut_out_pc_GW82 = np.zeros_like(cut_out_wind_speed_GW82)

fig, ax = plt.subplots(figsize=(9,6))
ax.stem(cut_in_wind_speed_GW82, cut_in_pc_GW82, markerfmt = 'ro', linefmt = 'r', basefmt = 'none', label = 'Below Cut-In')
ax.stem(cubic_wind_speed_GW82, cubic_pc_GW82, markerfmt = 'bo', linefmt = 'b', basefmt = 'none', label = 'Cubic Model')
ax.stem(rated_wind_speed_GW82, rated_pc_GW82, markerfmt = 'go', linefmt = 'g', basefmt = 'none', label = 'Rated')
ax.stem(cut_out_wind_speed_GW82, cut_out_pc_GW82, markerfmt = 'ro', linefmt = 'r', basefmt = 'none', label = 'Above Cut-Out')
# ax.set_ylim(0,4)
ax.set_xlabel('Wind Speed (m/s)')
ax.set_ylabel('Turbine Output (MW)')
ax.set_title('Modelled Power Curve for Goldwind GW82 1.5 MW (Gullen Range)')
ax.legend()

# plt.savefig('Gullen Range Turbine Power Curve (1_5 MW)', dpi = 600)
...
weather_data.to_csv('pvlib_gr.csv')
...
orientation['tracker_theta'].loc['2019-12-15'].fillna(0).plot(title='Tracker Orientation')
plt.show()
...
modelchain_sa = ModelChain(system_sa, location)
...
plt.title('Histogram of 10m Wind Speed at Gullen Range Wind Farm')
plt.xlim(0,15)
plt.savefig('10m WindSpeed Histogram Gullen Range', dpi = 600)
#%% Wind speed histrogram at 110m
plt.figure(figsize=(9,6))
plt.hist(v2_GW100, bins=31, edgecolor='black')
plt.xlabel('Wind Speed at 80m (m/s)')
plt.ylabel('Frequency')
plt.title('Histogram of Wind Speed at Hub Height for GW100 2.5 MW (Gullen Range Wind Farm)')
plt.xlim(0,15)
plt.savefig('80m WindSpeed Histogram Gullen Range', dpi = 600)

#%% Wind speed histrogram at 115m
plt.figure(figsize=(9,6))
plt.hist(v2_GW82, bins=31, edgecolor='black')
plt.xlabel('Wind Speed at 82m (m/s)')
plt.ylabel('Frequency')
plt.title('Histogram of Wind Speed at Hub Height for GW82 1.5 MW (Gullen Range Wind Farm)')
plt.xlim(0,15)
plt.savefig('82m WindSpeed Histogram Gullen Range', dpi = 600)
...
plt.ylabel('Frequency')
plt.title('Histogram of GHI at Gullen Range Solar Farm')
plt.savefig('GHI Histogram Gullen Range', dpi = 600)
plt.show()
...
plt.ylabel('Frequency')
plt.title('Histogram of DHI at Gullen Range Solar Farm')
plt.savefig('DHI Histogram Gullen Range', dpi = 600)
plt.show()
...
plt.ylabel('Frequency')
plt.title('Histogram of DNI at Gullen Range Solar Farm')
plt.savefig('DNI Histogram Gullen Range', dpi = 600)
plt.show()

#%% GHI, DNI, DHI Plot

hours_day = pd.date_range(start='2000-01-01', periods=24, freq='h')
summer = (weather_data['ghi'].loc['2017-01-16']).values
autumn = (weather_data['ghi'].loc['2019-04-10']).values
winter = (weather_data['ghi'].loc['2005-07-19']).values
spring = (weather_data['ghi'].loc['2003-10-21']).values
...
plt.title('Diurnal Cycle of GHI at Gullen Range')
plt.legend()

hours_formatter = mdates.DateFormatter('%H:%M')
plt.gca().xaxis.set_major_formatter(hours_formatter)

# plt.savefig('Diurnal Cycle GHI - Gullen Range', dpi=600)
...
plt.ylabel('Average Generation Output (GWh)')
# plt.title('Monthly Average Solar Generation for Strong and Neutral La Nina Conditions')
plt.title('Average Monthly Solar Generation at Gullen Range for varying La Nina Conditions')
plt.xticks(index + bar_width/2, month_names, rotation=45)
plt.legend(loc='lower right')
plt.tight_layout()
plt.savefig('Monthly Average Solar Generation (Gullen Range)', dpi=600)
plt.show()
...
plt.ylabel('Average Generation Output (GWh)')
# plt.title('Monthly Average Wind Generation for Strong and Neutral La Nina Conditions')
plt.title('Average Monthly Wind Generation at Gullen Range for varying La Nina Conditions')

plt.xticks(index + bar_width/2, month_names, rotation=45)
plt.legend(loc='lower right')
plt.tight_layout()
plt.savefig('Monthly Average Wind Generation (Gullen Range).png', dpi=600)
plt.show()
...
plt.title('SOI vs Wind PC1 (Gullen Range Wind Farm)')
plt.savefig('Gullen Range SOI PCA 1 (Wind).png', dpi=600)
plt.show()
...
plt.text(0.05, 0.95, f'Correlation: {correlation_coefficient:.3f}', transform=ax1.transAxes, fontsize=12, verticalalignment='top')
# plt.text(0.05, 0.95, f'Correlation: {explained_variance_ratio:.3f}', transform=ax1.transAxes, fontsize=12, verticalalignment='top')
plt.title('SOI vs Wind PC2 (Gullen Range Wind Farm)')
plt.savefig('Gullen Range SOI PCA 2 (Wind).png', dpi=600)
plt.show()
...
# ax2.legend()
plt.text(0.05, 0.95, f'Correlation: {correlation_coefficient:.3f}', transform=ax1.transAxes, fontsize=12, verticalalignment='top')
plt.title('ONI vs Wind PC1 (Gullen Range Wind Farm)')
plt.savefig('Gullen Range ONI PCA 1 (Wind).png', dpi=600)
plt.show()
...
# ax2.legend()
plt.text(0.05, 0.95, f'Correlation: {correlation_coefficient:.3f}', transform=ax1.transAxes, fontsize=12, verticalalignment='top')
plt.title('ONI vs Wind PC2 (Gullen Range Wind Farm)')
plt.savefig('Gullen Range ONI PCA 2 (Wind).png', dpi=600)
plt.show()
...
# ax2.legend()
plt.text(0.05, 0.95, f'Correlation: {correlation_coefficient:.3f}', transform=ax1.transAxes, fontsize=12, verticalalignment='top')
plt.title('SOI vs PC1 (Gullen Range Solar Farm)')
plt.savefig('Gullen Range SOI PCA 1 (Solar).png', dpi=600)
plt.show()
...
# ax2.legend()
plt.text(0.05, 0.95, f'Correlation: {correlation_coefficient:.3f}', transform=ax1.transAxes, fontsize=12, verticalalignment='top')
plt.title('SOI vs PC2 (Gullen Range Solar Farm)')
plt.savefig('Gullen Range SOI PCA 2 (Solar).png', dpi=600)
plt.show()
...
# ax2.legend()
plt.text(0.05, 0.95, f'Correlation: {correlation_coefficient:.3f}', transform=ax1.transAxes, fontsize=12, verticalalignment='top')
plt.title('ONI ANOM vs PC1 (Gullen Range Solar Farm)')
plt.savefig('Gullen Range ONI PCA 1 (Solar).png', dpi=600)
plt.show()
...
# ax2.legend()
plt.text(0.05, 0.95, f'Correlation: {correlation_coefficient:.3f}', transform=ax1.transAxes, fontsize=12, verticalalignment='top')
plt.title('ONI ANOM vs PC2 (Gullen Range Solar Farm)')
plt.savefig('Gullen Range ONI PCA 2 (Solar).png', dpi=600)
plt.show()
