# -*- coding: utf-8 -*-
"""
Created on Mon Jul 31 12:38:43 2023
...
skep1 = xr.open_dataset('swhiterock1.grib', engine = 'cfgrib', chunks = 1000)
skep2 = xr.open_dataset('swhiterock2.grib', engine = 'cfgrib', chunks = 1000)
skep3 = xr.open_dataset('swhiterock3.grib', engine = 'cfgrib', chunks = 1000)

kep1 = xr.open_dataset('whiterock1.grib', engine = 'cfgrib', chunks = 1000)
kep2 = xr.open_dataset('whiterock2.grib', engine = 'cfgrib', chunks = 1000)
kep3 = xr.open_dataset('whiterock3.grib', engine = 'cfgrib', chunks = 1000)
kep4 = xr.open_dataset('whiterock4.grib', engine = 'cfgrib', chunks = 1000)
kep5 = xr.open_dataset('whiterock5.grib', engine = 'cfgrib', chunks = 1000)
kep6 = xr.open_dataset('whiterock6.grib', engine = 'cfgrib', chunks = 1000)
kep7 = xr.open_dataset('whiterock7.grib', engine = 'cfgrib', chunks = 1000)
kep8 = xr.open_dataset('whiterock8.grib', engine = 'cfgrib', chunks = 1000)
kep9 = xr.open_dataset('whiterock9.grib', engine = 'cfgrib', chunks = 1000)
...
kep_v1 = kep1.v10.values[:,0,0]
kep_v2 = kep2.v10.values[:,0,0]
kep_v3 = kep3.v10.values[:,0,0]
kep_v4 = kep4.v10.values[:,0,0]
kep_v5 = kep5.v10.values[:,0,0]
kep_v6 = kep6.v10.values[:,0,0]
kep_v7 = kep7.v10.values[:,0,0]
kep_v8 = kep8.v10.values[:,0,0]
kep_v9 = kep9.v10.values[:,0,0]
...
v = np.concatenate([kep_v1, kep_v2, kep_v3, kep_v4, kep_v5, kep_v6, kep_v7,
                    kep_v8, kep_v9])
...
pca_swind = pd.DataFrame({'Date':date_range})
pca_swind['SOI'] = soi['ANOM']
pca_swind['pca1'] = principal_components_swind[:,0]
pca_swind['pca2'] = principal_components_swind[:,1]

correlation_coefficient = np.corrcoef(soi['ANOM'], pca_swind['pca1'])[0, 1]

fig, ax1 = plt.subplots(figsize=(10,8))

ax1.plot(date_range, soi['ANOM'], label='SOI ANOM', color='blue')
...
ax2.plot(date_range, pca_swind['pca2'], label='PCA 2', color='green')
ax2.set_ylabel('PCA 2', color='green')
...
pca_owind = pd.DataFrame({'Date':date_range})
pca_owind['ONI'] = - oni['ANOM']
pca_owind['pca1'] = principal_components_owind[:,0]
pca_owind['pca2'] = principal_components_owind[:,1]

correlation_coefficient = np.corrcoef(oni['ANOM'], pca_owind['pca2'])[0, 1]

fig, ax1 = plt.subplots(figsize=(10,8))

ax1.plot(date_range, oni['ANOM'], label='ONI ANOM', color='blue')
...
ax2.plot(date_range, pca_owind['pca2'], label='PCA 2', color='green')
ax2.set_ylabel('PC2', color='green')
ax2.tick_params(axis='y', labelcolor='green')
ax2.set_ylim(-4,4)
...
pca_ssolar = pd.DataFrame({'Date':date_range})
pca_ssolar['SOI'] = soi['ANOM']
...
ax2.plot(date_range, pca_ssolar['pca1'], label='PCA 1', color='green')
ax2.set_ylabel('PCA 1', color='green')
ax2.tick_params(axis='y', labelcolor='green')
ax2.set_ylim(-4,4)
...
correlation_coefficient = np.corrcoef(soi['ANOM'], pca_ssolar['pca1'])[0, 1]
...
pca = PCA(n_components=2)
principal_components_osolar = pca.fit_transform(scaled_wind)
explained_variance_ratio = pca.explained_variance_ratio_
...
pca_osolar = pd.DataFrame({'Date':date_range})
pca_osolar['ONI'] = - oni['ANOM']
pca_osolar['pca1'] = principal_components_osolar[:,0]
pca_osolar['pca2'] = principal_components_osolar[:,1]

correlation_coefficient = np.corrcoef(-oni['ANOM'], pca_osolar['pca1'])[0, 1]
...
ax2.plot(date_range, pca_osolar['pca1'], label='PCA 1', color='green')
ax2.set_ylabel('PCA 1', color='green')
ax2.tick_params(axis='y', labelcolor='green')
ax2.set_ylim(-4,4)
...
plt.plot(oni['ANOM'])
plt.plot(principal_components_owind[:,0])
...
plt.plot(soi['ANOM'])
plt.plot(principal_components_ssolar[:,0])
...
plt.plot(oni['ANOM'])
plt.plot(principal_components_osolar[:,0])
